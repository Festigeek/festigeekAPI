...
class DatabaseSeederv2 extends Seeder
{
  ...
  //products
  //2018 event id
  $p7 = Product::create(['name' => 'League Of Legend', 'description' => 'Inscription LoL 2018.', 'price' => '20.00','quantity_max' => '80', 'sold' => '0', 'event_id' => 2, 'product_type_id' => 1, 'need_team'=>1]);
  ...
  $p9 = Product::create(['name' => 'Counter-Strike: GO', 'description' => 'Inscription CS:GO 2018.', 'price' => '20.00', 'quantity_max' => '40', 'sold' => '0', 'event_id' => 2, 'product_type_id' => 1, 'need_team'=>1]);
  $p10 = Product::create(['name' => 'Animations', 'description' => 'Place joueur LAN 2018.', 'price' => '20.00', 'quantity_max' => '6', 'sold' => '0', 'event_id' => 2, 'product_type_id' => 1, 'need_team'=>0]);
