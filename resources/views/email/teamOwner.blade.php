...
<html lang="fr">
  ...
  <body>
    ...
    <div>
      ...
      <p>
        Afin d'inviter tous tes amis (ou futur ex-amis, selon le jeu choisi), donne-leur à tous le code suivant:
      </p>

      <h3 style="text-align:center;">{{ $team->code }}</h3>


      <p>Ils pourront ainsi effectuer leur commande en étant automatiquement ajouté à ton équipe. Si c'est pas beau la technologie...</p>
